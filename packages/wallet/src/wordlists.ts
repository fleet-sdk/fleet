...
export { wordlist as chinese_simplified } from "@scure/bip39/wordlists/simplified-chinese";
export { wordlist as chinese_traditional } from "@scure/bip39/wordlists/traditional-chinese";
