...
| [@fleet-sdk/wallet](/packages/wallet) | Wallet related library, with keys creation and derivation.                           | [![npm](https://badgen.net/npm/v/@fleet-sdk/wallet)](https://www.npmjs.com/package/@fleet-sdk/wallet) |
